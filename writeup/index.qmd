...
Power|Necessary N
---|---
80%|`r knitr::kable(unclass(pwr::pwr.t.test(n=6, d=cohensd$Cohens_d, sig.level=.05, type="one.sample", alternative="two.sided")))`
90%|`r knitr::kable(unclass(pwr::pwr.t.test(n=8, d=cohensd$Cohens_d, sig.level=.05, type="one.sample", alternative="two.sided")))`
95%|`r knitr::kable(unclass(pwr::pwr.t.test(n=9, d=cohensd$Cohens_d, sig.level=.05, type="one.sample", alternative="two.sided")))`
