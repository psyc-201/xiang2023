...
- They also thought that collaborators' chance of succeeding together gradually increased as they succeeded more alone (i.e., that collaborators thought about each other's effort and tried to distribute effort fairly)  
  <!-- ![](./fig3c_behavioral_only.png){height=200} -->
- **Authors' proposed "joint effort" model was the only one that explained both above effects**  
  <!-- ![](../writeup/original-fig3c.png){height=200} -->
...
Collaborators' chance of succeeding together gradually increased as they succeeded more alone
:::
